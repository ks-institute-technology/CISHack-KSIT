        ...
        <Route path="/">
          <div className="app">
            ...
            >
              ...
              <DialogContent dividers>
                {courses != null && courses?.length > 0 ? (
                  ...
                  <Button
                        onClick={() => window.open("https://Challenges.shreydd.repl.co", "_self")}
            ...
            <div className="buttons">
              ...
              <Button className="button-hier"> <a href="https://crafts.shreydd.repl.co"> Hire </a></Button>
            </div>
          </div>
        </Route>
      </Switch>
